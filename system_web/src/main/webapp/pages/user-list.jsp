	...
	<div class="wrapper">
		...
		<div class="content-wrapper">
			...
			<ol class="breadcrumb">
				...
				<li><a
					href="${pageContext.request.contextPath}/user/findAll?page=1&size=${pageInfo.pageSize}">用户管理</a></li>
									...
									<c:forEach items="${pageInfo.list}" var="user">
										<tr>
											...
											<td class="text-center">
												...
												<a href="${pageContext.request.contextPath}/user/findUserByIdAndOtherRole?userId=${user.id}" class="btn bg-olive btn-xs">添加角色</a>
												<a href="${pageContext.request.contextPath}/user/delete?id=${user.id}" class="btn bg-olive btn-xs" onclick="return confirm('确认删除？')">删除用户</a>
											</td>
										</tr>
									</c:forEach>
								</tbody>
						...
						<div class="box-tools pull-right">
							<ul class="pagination">
								...
								<c:forEach begin="1" end="${pageInfo.pages}" var="i">
									<li><a href="${pageContext.request.contextPath}/user/findAll?page=${i}&size=${pageInfo.pageSize}">${i}</a></li>
								</c:forEach>
								<%--<li><a href="#">1</a></li>
                                <li><a href="#">2</a></li>
                                <li><a href="#">3</a></li>
